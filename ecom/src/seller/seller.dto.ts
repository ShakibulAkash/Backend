import { IsString, Matches, IsEmail, MinLength, MaxLength, IsNotEmpty } from "class-validator";
...
export class OrderDTO{
    ...
    @IsNotEmpty({ message: 'Order ID cannot be empty or null' })
    Order_ID : number;

    @IsNotEmpty({ message: 'Order Date cannot be empty or null' })
    Order_Date : string;

    @IsNotEmpty({ message: 'Order Status cannot be empty or null' })
    Order_Status : string;

    @IsNotEmpty({ message: 'Order Total cannot be empty or null' })
    Book_Name : string;
